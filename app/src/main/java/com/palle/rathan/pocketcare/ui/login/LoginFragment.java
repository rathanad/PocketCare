package com.palle.rathan.pocketcare.ui.login;
...
import com.palle.rathan.pocketcare.ui.SumTransActivity;
        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!validateUsername() || !validatePassword()) {
                    ...
                    Intent in = new Intent(getActivity(), SumTransActivity.class);
                    startActivity(in);
                    getActivity().finish();
